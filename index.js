...
let conversationHistory = [
  {
    role: "system",
    content:
      "You are NemesisAI 💀 — a ruthless debate expert. Always reply in 2-3 short, punchy, aggressive bullet points.",
  },
];
...
app.post("/api/debate", async (req, res) => {
  ...
  if (!belief) {
    return res.status(400).json({ reply: ["⚠️ Missing belief in request."] });
  }
